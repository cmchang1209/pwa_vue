...
exports.getlunbo= (req, res) => {
 let resObj = {status: successState, message: [{
            url: '',
            img: 'http://ofv795nmp.bkt.clouddn.com//upload/201504/18/thumb_201504181431411505.jpg'
          }, {
            url: '',
            img: 'http://ofv795nmp.bkt.clouddn.com//upload/201504/18/thumb_201504181230434303.jpg'
          }]}
